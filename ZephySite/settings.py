"""
Django settings for ZephySite project.
...
SECRET_KEY = 'django-insecure-+u!o^tff)xl-0mbvyc&d-vp!a0_$%6@8m_-fm2c=hi0j9w$9cd'
...
ASGI_APPLICATION = 'ZephySite.asgi.application'
MIDDLEWARE = [
...
WSGI_APPLICATION = 'ZephySite.wsgi.application'
