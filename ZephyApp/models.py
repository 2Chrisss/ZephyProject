...
class Boxprofesional(models.Model):
    pk = models.CompositePrimaryKey('idBoxProfesionalcol', 'Box_idBox', 'Profesional_idProfesional')
    idboxprofesionalcol = models.CharField(db_column='idBoxProfesionalcol', max_length=45)  # Field name made lowercase.
    horarioreserva = models.DateTimeField(db_column='horarioReserva', blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        ...
        unique_together = (('idboxprofesionalcol', 'box_idbox', 'profesional_idprofesional'),)
